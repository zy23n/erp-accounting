...
public class PayrollQueryController {
    ...
    public ResponseEntity<PayrollResponse> getPayroll(
        ...
        return ResponseEntity.ok(payrollQueryService.getPayroll(payrollId, user));
    }
    ...
    public ResponseEntity<Page<PayrollListResponse>> getPayrollList(
        ...
        return ResponseEntity.ok(payrollQueryService.searchPayrolls(user, command, pageable));
    }
}
